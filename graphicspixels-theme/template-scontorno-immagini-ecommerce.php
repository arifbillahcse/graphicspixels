<?php /* Template Name: Scontorno Immagini Ecommerce (IT) */ ?>
<!DOCTYPE html>
<html lang="it">
<head>
    <meta charset="UTF-8">
    ...
    <?php wp_head(); ?>
<style>
        /* ===== Page-scoped styles — Scontorno E-commerce ===== */
...
<!-- ============ HEADER / NAVIGATION ============ -->
    ...
    <section class="dt-showcase">
        ...
        <div class="container">
            <div class="dt-showcase-content reveal" data-reveal="left">
                <span class="dt-showcase-eyebrow">✨ Studio di Post-Produzione Premium &amp; Alta Moda Italiana</span>
                <h1>Scontorno Immagini e Fotoritocco Professionale — Tracciati al 100% a Mano</h1>
                <p class="dt-showcase-lead">Trasforma i prodotti del tuo e-commerce in elementi visivi ad alta conversione.</p>
                <p>Lo studio di post-production <strong>Graphics Pixels</strong> offre servizi premium per brand di moda e studi fotografici italiani. Nessun automatismo IA, solo precisione assoluta con lo strumento penna di Photoshop. Consegna rapida in 24-48 ore.</p>
                <ul class="dt-showcase-icons">
                    <li><i class="fas fa-shield-halved"></i> Accordo NDA Garantito</li>
                    <li><i class="fas fa-bolt"></i> Consegna 24h-48h</li>
                    <li><i class="fas fa-fire"></i> Zero Filtri IA</li>
                </ul>
                <div class="dt-showcase-actions">
                    <a href="#free-trial" class="btn btn-primary">Inizia la tua prova gratuita (Fino a 5 immagini)</a>
                </div>
            </div>
        </div>
    </section>
    ...
    <!-- ============ PERCHÉ SCEGLIERCI ============ -->
    <section class="dt-section" id="perche">
        <div class="container">
            <div class="dt-head">
                <span class="section-tag">Perché Sceglierci</span>
                <h2 class="section-title">Perché Scegliere Graphics Pixels?</h2>
                <p>La perfezione del tocco umano per massimizzare le conversioni del tuo e-commerce.</p>
            </div>
            <div class="dt-values">
                <div class="dt-value-card">
                    <div class="dt-value-icon"><i class="fas fa-pen-nib"></i></div>
                    <h3>Scontorno Manuale di Precisione (No IA)</h3>
                    <p>Gli algoritmi automatici sacrificano i dettagli critici dei bordi. I nostri oltre 120 professionisti interni tracciano ogni singolo pixel a mano, garantendo zoom perfetti su Shopify, Amazon e cataloghi cartacei di alta gamma.</p>
                </div>
                <div class="dt-value-card">
                    <div class="dt-value-icon"><i class="fas fa-shirt"></i></div>
                    <h3>Effetto Manichino Invisibile (Ghost Mannequin)</h3>
                    <p>Dai vita e volume ai tuoi capi d'abbigliamento. Uniamo i colletti, eliminiamo i manichini e perfezioniamo la simmetria dei tessuti seguendo gli standard rigorosi delle migliori case di moda di Milano.</p>
                </div>
                <div class="dt-value-card">
                    <div class="dt-value-icon"><i class="fas fa-shield-halved"></i></div>
                    <h3>Massima Riservatezza &amp; Accordo NDA</h3>
                    <p>Sappiamo quanto sia importante proteggere il lancio di una nuova collezione. Tutti i tuoi asset visivi sono al sicuro sui nostri server protetti. Siamo pronti a firmare un accordo di riservatezza (NDA) prima di ricevere i file.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <!-- ============ I NOSTRI SERVIZI ============ -->
    <section class="dt-section alt" id="servizi">
        <div class="container">
            <div class="dt-head">
                <span class="section-tag">I Nostri Servizi</span>
                <h2 class="section-title">I Nostri Servizi di Post-Produzione</h2>
                <p>Servizi professionali di fotoritocco su misura per cataloghi, web e stampa.</p>
            </div>
            <div class="dt-services">
                <div class="dt-service-item">
                    <div class="dt-service-ico"><i class="fas fa-image"></i></div>
                    <div>
                        <h3>Scontorno e Rimozione Sfondo</h3>
                        <p>Sfondi bianchi puri per i marketplace (Amazon/eBay) o sfondi trasparenti (PNG/PSD) pronti per il tuo negozio Shopify.</p>
                    </div>
                </div>
                <div class="dt-service-item">
                    <div class="dt-service-ico"><i class="fas fa-gem"></i></div>
                    <div>
                        <h3>Fotoritocco di Alta Gioielleria</h3>
                        <p>Pulizia meticolosa dei metalli preziosi, esaltazione della lucentezza dei diamanti ed eliminazione totale dei riflessi della fotocamera.</p>
                    </div>
                </div>
                <div class="dt-service-item">
                    <div class="dt-service-ico"><i class="fas fa-scissors"></i></div>
                    <div>
                        <h3>Mascheratura di Immagini Complesse</h3>
                        <p>Isolamento perfetto e ultra-dettagliato di soggetti complessi come capelli, pellicce, lacci e ricami intricati.</p>
                    </div>
                </div>
                <div class="dt-service-item">
                    <div class="dt-service-ico"><i class="fas fa-clone"></i></div>
                    <div>
                        <h3>Ombre Naturali e Riflessi</h3>
                        <p>Creazione di ombre portate, sfumate o riflessi specchiati di alta qualità per dare profondità e realismo al prodotto.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <!-- ============ IL NOSTRO PROCESSO ============ -->
    <section class="dt-process" id="processo">
        <div class="container">
            <div class="dt-head">
                <span class="section-tag light">Il Nostro Processo</span>
                <h2 class="section-title">Come funziona?</h2>
                <p>Un flusso di lavoro fluido, veloce e sicuro pensato per il tuo team.</p>
            </div>
            <div class="dt-steps">
                <div class="dt-step">
                    <div class="dt-step-num">1</div>
                    <h3>Invia i tuoi file</h3>
                    <p>Carica le tue immagini grezze tramite il nostro modulo protetto o condividi un link (Drive, Dropbox, FTP) con le tue linee guida.</p>
                </div>
                <div class="dt-step">
                    <div class="dt-step-num">2</div>
                    <h3>Produzione e Controllo Qualità</h3>
                    <p>I nostri esperti lavorano manualmente ogni dettaglio. Un supervisore senior verifica la conformità e la perfezione dei tracciati prima della consegna.</p>
                </div>
                <div class="dt-step">
                    <div class="dt-step-num">3</div>
                    <h3>Scarica le immagini pronte</h3>
                    <p>Ricevi i file pronti per la pubblicazione in 24h-48h, ottimizzati per le prestazioni e la SEO del sito web nei formati WebP o AVIF.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <!-- ============ TARIFFE ============ -->
    <section class="dt-section" id="tariffe">
        <div class="container">
            <div class="dt-head">
                <span class="section-tag">Tariffe</span>
                <h2 class="section-title">Tariffe Flessibili e Competitive</h2>
                <p>Nessun costo o abbonamento nascosto. Paghi solo per quello che ordini.</p>
            </div>
            <div class="dt-pricing">
                <div class="dt-price-card">
                    <h3>Piccoli Volumi</h3>
                    <p>Ideale per boutique indipendenti, startup e test di nuove collezioni.</p>
                    <div class="dt-price-amount">Preventivi su misura</div>
                    <ul class="dt-price-list">
                        <li><i class="fas fa-check"></i> Nessun ordine minimo richiesto</li>
                        <li><i class="fas fa-check"></i> Formati PSD, PNG, WebP, AVIF</li>
                        <li><i class="fas fa-check"></i> Supporto clienti dedicato e rapido</li>
                    </ul>
                </div>
                <div class="dt-price-card featured">
                    <span class="dt-price-badge">Popolare</span>
                    <h3>Grandi Volumi / E-commerce</h3>
                    <p>Perfetto per brand di moda consolidati e agenzie con grandi volumi mensili.</p>
                    <div class="dt-price-amount">Prezzi Scalabili 🔥</div>
                    <ul class="dt-price-list">
                        <li><i class="fas fa-check"></i> Tariffe super competitive a scendere</li>
                        <li><i class="fas fa-check"></i> Gestione di oltre 3.000+ immagini/mese</li>
                        <li><i class="fas fa-check"></i> Team di editor dedicato &amp; Project Manager</li>
                        <li><i class="fas fa-check"></i> Accordo NDA per la massima riservatezza</li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <section class="dt-testimonial">
        <div class="container">
            ...
            <blockquote>"Il partner perfetto per la nostra agenzia di moda"</blockquote>
            <p class="dt-testimonial-text">
                "Collaboriamo con Graphics Pixels per la gestione di tutti i cataloghi e-commerce della nostra agenzia a Milano. Gestiscono volumi di oltre 3.000 immagini a settimana con una precisione chirurgica sul ghost mannequin. Puntuali e professionali."
            </p>
            <div class="dt-testimonial-author">— Alessandro M., <span>Art Director, Milano</span></div>
        </div>
    </section>
    ...
    <section class="dt-section alt" id="faq">
        <div class="container">
            <div class="dt-head">
                ...
                <p>Risposte chiare ottimizzate per gli standard di ricerca e performance del 2026.</p>
            </div>
            <div class="dt-faq-list">
                <div class="dt-faq-item">
                    <button class="dt-faq-q">
                        <span>C'è un volume minimo di immagini per inviare un ordine a Graphics Pixels?</span>
                        <i class="fas fa-plus dt-faq-icon"></i>
                    </button>
                    <div class="dt-faq-a">
                        <div class="dt-faq-a-inner">
                            No, non richiediamo un ordine minimo. Gestiamo con la stessa attenzione sia piccoli lotti di 10 immagini per startup e boutique indipendenti, sia produzioni industriali da oltre 10.000 immagini per grandi marketplace, offrendo tariffe flessibili e competitive.
                        </div>
                    </div>
                </div>
                <div class="dt-faq-item">
                    <button class="dt-faq-q">
                        <span>In quali formati di file consegnate il lavoro finito?</span>
                        <i class="fas fa-plus dt-faq-icon"></i>
                    </button>
                    <div class="dt-faq-a">
                        <div class="dt-faq-a-inner">
                            Consegniamo nei formati standard richiesti per la stampa e l'editing (PSD, TIFF, PNG). Inoltre, in linea con gli standard SEO del 2026 per massimizzare la velocità dei siti web, ottimizziamo i tuoi file nei formati di nuova generazione WebP e AVIF, garantendo immagini leggere senza alcuna perdita di dettaglio.
                        </div>
                    </div>
                </div>
                <div class="dt-faq-item">
                    <button class="dt-faq-q">
                        <span>Come posso testare la qualità del vostro servizio?</span>
                        <i class="fas fa-plus dt-faq-icon"></i>
                    </button>
                    <div class="dt-faq-a">
                        <div class="dt-faq-a-inner">
                            Il nostro test è al 100% gratuito e senza vincoli. Ti basta caricare da 1 a 5 immagini di prova tramite il nostro modulo online, specificando le tue linee guida. Elaboreremo i file e te li rispediremo per una valutazione: deciderai di collaborare con noi solo se sarai soddisfatto del risultato.
                        </div>
                    </div>
                </div>
            </div>
    ...
    <!-- ============ CTA FINALE ============ -->
    <section class="dt-cta" id="prova-gratuita">
        <div class="container">
            <h2>Pronto a trasformare i tuoi prodotti?</h2>
            <p>Unisciti ai brand e alle agenzie che si affidano a Graphics Pixels per una post-produzione manuale premium e risultati d'eccellenza.</p>
            <a href="#free-trial" class="btn btn-primary">Inizia la tua prova gratuita ora</a>
        </div>
    </section>
